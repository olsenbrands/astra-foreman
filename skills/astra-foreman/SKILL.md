---
name: astra-foreman
description: Lead economical, evidence-driven agent work in Codex with Astra or Sol. Use for foreman mode, planning delegated builds, independent plan review, delegating coding or research, choosing worker and reviewer models, coordinating coding sprints, or recovering a stalled agent program.
---
...
Sol can both lead; changing between them does not restart the workflow.
...
- **Direct:** a quick change, small answer, or tightly coupled fix where writing
  ...
  is allowed. Meaningful logic still gets independent review when available.
...
Before delegated review, read [productivity.md](references/productivity.md).
...
and delivery checkpoints; sprints for long work. Load only what the task needs.
